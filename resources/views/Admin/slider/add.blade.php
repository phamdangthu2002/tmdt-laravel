...
@section('content')
    ...
    <style>
        ...
        #preview-zone img {
            width: 100%;
            /* Chiều rộng ảnh chiếm toàn bộ không namen của phần tử chứa */
            height: auto;
    ...
    <form action="{{ route('admin.store-slider') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="container-danhmuc mt-5">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" value="1" id="sort_by" name="sort_by"
            ...
            <button type="submit" class="btn btn-primary mt-3">Thêm slider</button>
        </div>
    </form>
